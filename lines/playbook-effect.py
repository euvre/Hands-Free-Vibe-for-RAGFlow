...
HOUSES_F = os.path.join(DIR, "playbook-houses.md")
...
def write_houses_section(rows, H, golden_ids=frozenset()):
    """The rolling section lives in playbook-houses.md — generated state,
    git-ignored like playbook-golden.md, so the hand-curated playbook.md
    stops churning in git on every sweep."""
    lines = ["## Rolling additions (eight houses, effect-weighted by iterations)",
             "(generated by playbook-effect on every summarize sweep — do not hand-edit)", "",
